...
/**
 * parse directive models to do the array update transform. a[idx] = val => $$a.splice($$idx, 1, val)
 *
...
function model (
...

  {
    ...
    if (tag === 'input' && dynamicType) {
      warn$1(
        "<input :type=\"" + dynamicType + "\" v-models=\"" + value + "\">:\n" +
        "v-models does not support dynamic input types. Use v-if branches instead."
      );
    }
